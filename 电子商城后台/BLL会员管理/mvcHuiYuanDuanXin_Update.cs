...
namespace BLL会员管理
{
    public class mvcHuiYuanDuanXin_Update
    {
        DALPublic.DALMethod myDALMethod = new DALPublic.DALMethod();
       
        #region 根据会员类别ID查询会员类别信息
        public DataTable ChaXunHuiYuanDuanXin(int HuiYuanDuanXinID)
        {
            ...
            SQlCMDpas[0].Value = "ChaXunHuiYuanDuanXin";
            SQlCMDpas[1].Value = HuiYuanDuanXinID;
            DataTable dt = myDALMethod.DAL_SelectDB_Par("UIL会员管理_mvcHuiYuanDuanXin_Update", SQlCMDpas);
            return dt;
        }
        #endregion
        #region 修改会员
        public int XiuGaiHuiYuanDuanXin(int strHuiYuanDengJiID, int strHuiYuanZhuangTaiID, string strYongHuMing, string strMiMa, string strNiCheng, string strYouXiang, string strXingBie, string strQQ, string strBanGongDianHua, string strShouJi, string strLianXiDiZhi,
                                     int intHuiYuanID
                                       )
        {
            ...
            SQlCMDpas[0].Value = "XiuGaiHuiYuanDuanXin";
            ...
            int i = myDALMethod.DAL_OPTableDB_Par("UIL会员管理_mvcHuiYuanDuanXin_Update", SQlCMDpas);
            return i;
        }
        #endregion
