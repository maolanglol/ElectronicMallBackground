...
namespace BLL会员管理
{
    public class mvcHuiYuanXinXi_Insert
    {
        ...
        public DataTable ChaXunHuiYuanDengJi()
        {
            ...
            DataTable dt = myDALMethod.DAL_SelectDB_Par("UIL会员管理_mvcHuiYuanXinXi_Insert", SQlCMDpas);
            return dt;
        }
        #endregion
        #region 查询会员等级
        ...
        #endregion
        #region 添加会员
        public int TianJiaHuiYuanXinXi(int strHuiYuanDengJiID, int strHuiYuanZhuangTaiID, string strYongHuMing, string strMiMa, string strNiCheng, string strYouXiang, string strXingBie, string strQQ, string strBanGongDianHua, string strShouJi, string strLianXiDiZhi
                                       ) 
        {
            ...
            SQlCMDpas[0].Value = "TianJiaHuiYuanXinXi";
            ...
            int i = myDALMethod.DAL_OPTableDB_Par("UIL会员管理_mvcHuiYuanXinXi_Insert", SQlCMDpas);
            return i;
        }
        #endregion
