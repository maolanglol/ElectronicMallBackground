...
namespace BLL销售管理
{
    public class mvcZhiFuFangShi_Insert
    {
        ...
        public DataTable ChaXunHuiYuanDengJi()
        {
            ...
            DataTable dt = myDALMethod.DAL_SelectDB_Par("UIL销售管理_mvcZhiFuFangShi_Insert", SQlCMDpas);
            return dt;
        }
        #endregion
        #region 查询支付方式
        ...
        #endregion
        #region 添加支付方式
        public int TianJiaZhiFuFangShi(string strMingCheng, string strZhiFuMiaoShu, string strPaiXu, string strZhuangTai) 
        {
            ...
            SQlCMDpas[0].Value = "TianJiaZhiFuFangShi";
            ...
            int i = myDALMethod.DAL_OPTableDB_Par("UIL销售管理_mvcZhiFuFangShi_Insert", SQlCMDpas);
            return i;
        }
        #endregion
